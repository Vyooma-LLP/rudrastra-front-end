      ...
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-10 pb-24 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-4 gap-4">
            {[1,2,3,4].map((i) => (
              <div key={i} className={`aspect-square border ${i===1 ? 'border-[var(--foreground)]' : 'border-[var(--border)]'} bg-white flex items-center justify-center cursor-pointer hover:border-[var(--foreground)] transition-colors duration-fast`}>
                <Image src={product.img} alt="Thumbnail" width={60} height={60} className="object-contain opacity-60 hover:opacity-100 transition-opacity" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="lg:col-span-7 flex flex-col">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            <div className="flex flex-col">
              <span className="font-heading font-bold text-[20px]">{product.specs.electrical[1].val}</span>
              <span className="font-sans text-[12px] text-[var(--muted-foreground)]">Voltage</span>
            </div>
            <div className="flex flex-col">
              <span className="font-heading font-bold text-[20px]">{product.specs.electrical[0].val}</span>
              <span className="font-sans text-[12px] text-[var(--muted-foreground)]">KV Rating</span>
            </div>
            <div className="flex flex-col">
              <span className="font-heading font-bold text-[20px]">8.2kg</span>
              <span className="font-sans text-[12px] text-[var(--muted-foreground)]">Max Thrust</span>
            </div>
            <div className="flex flex-col">
              <span className="font-heading font-bold text-[20px]">{product.specs.mechanical[2].val}</span>
              <span className="font-sans text-[12px] text-[var(--muted-foreground)]">Weight</span>
            </div>
          </div>
          ...
          <div className="mb-16 bg-white border border-[var(--border)] p-8">
            ...
            <Link href={`/compatibility?component=${product.id}`} className="inline-flex items-center gap-2 font-sans font-bold text-[14px] text-[var(--foreground)] hover:text-[var(--primary)] transition-colors duration-fast">
