...
/**
 * P0: Products Discovery Engine
 * Implements strict engineering filters (Category, Electrical, Interface, Physical, Commercial)
 * and the dense product card architecture.
 */
    ...
    <div className="w-full flex flex-col min-h-screen bg-[#F5F5F5]">
      ...
      <section className="w-full bg-white border-b border-[var(--border)] px-6 lg:px-10 py-16">
        ...
        <div className="w-full max-w-4xl relative flex items-center group">
          ...
          />
          <button className="absolute right-2 top-2 bottom-2 bg-[var(--foreground)] text-white font-sans font-semibold text-[14px] px-8 hover:bg-[var(--primary)] transition-colors duration-fast flex items-center gap-2 group/btn">
            Search
        ...
        <div className="flex-1">
          ...
          <div className="mt-12 flex justify-center">
            <div className="flex items-center gap-2">
              <button className="w-10 h-10 border border-[var(--border)] flex items-center justify-center hover:border-[#111] transition-colors duration-fast disabled:opacity-50 disabled:hover:border-[var(--border)]" disabled>
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="square" strokeLinejoin="miter" d="M15 19l-7-7 7-7" />
                </svg>
              </button>
              <button className="w-10 h-10 border border-[#111] bg-[#111] text-white flex items-center justify-center font-sans font-bold text-[13px]">1</button>
              <button className="w-10 h-10 border border-[var(--border)] flex items-center justify-center font-sans font-medium text-[13px] hover:border-[#111] transition-colors duration-fast">2</button>
              <button className="w-10 h-10 border border-[var(--border)] flex items-center justify-center font-sans font-medium text-[13px] hover:border-[#111] transition-colors duration-fast">3</button>
              <span className="mx-2 text-[var(--muted-foreground)]">...</span>
              <button className="w-10 h-10 border border-[var(--border)] flex items-center justify-center hover:border-[#111] transition-colors duration-fast">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
