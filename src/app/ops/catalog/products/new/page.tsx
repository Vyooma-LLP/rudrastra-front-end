...
export default function AddProductPage() {
  ...
  const [specs, setSpecs] = useState<{ section: string, label: string, val: string }[]>([]);
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="font-heading text-2xl font-bold text-[#111111] tracking-tight">Add New Product</h1>
        <p className="text-xs text-[#777777]">Enter the product details below. These will be immediately visible on the storefront.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 border border-[#E5E5E5]">
        <div className="space-y-1">
          ...
          <input required name="title" type="text" className="w-full border border-[#E5E5E5] p-2 text-sm font-sans" placeholder="e.g. T-Motor MN4014-400KV" />
        </div>

        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#111111] uppercase tracking-wider">Manufacturer Part Number (MPN) *</label>
            <input required name="mpn" type="text" className="w-full border border-[#E5E5E5] p-2 text-sm font-sans" placeholder="e.g. MN4014" />
          </div>
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#111111] uppercase tracking-wider">SKU</label>
            <input name="sku" type="text" className="w-full border border-[#E5E5E5] p-2 text-sm font-mono" placeholder="TM-MN4014" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <input required name="price" type="number" min="0" step="1" className="w-full border border-[#E5E5E5] p-2 text-sm font-mono" placeholder="2500" />
          </div>
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#111111] uppercase tracking-wider">Initial Stock *</label>
            <input required name="stockQty" type="number" min="0" defaultValue="0" className="w-full border border-[#E5E5E5] p-2 text-sm font-mono" />
          </div>
        </div>
        ...
        <div className="space-y-1">
          ...
          <textarea name="description" rows={4} className="w-full border border-[#E5E5E5] p-2 text-sm font-sans" placeholder="Product details..."></textarea>
        </div>

        <div className="flex items-center space-x-2 pt-2">
          <input type="checkbox" name="isActive" id="isActive" defaultChecked className="h-4 w-4 border-[#E5E5E5] text-black focus:ring-black" />
