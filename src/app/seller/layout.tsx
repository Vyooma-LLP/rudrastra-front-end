        ...
        <aside className="w-full md:w-64 bg-white border border-[#E5E5E5] p-6 flex flex-col justify-between shrink-0 space-y-6 shadow-sm">
          <div className="space-y-6">
            ...
            <nav className="space-y-1 text-xs font-medium">
              {isFeatureEnabled('sellerDashboard') && (
              ...
              {isFeatureEnabled('sellerInventory') && (
              ...
              {isFeatureEnabled('sellerPayouts') && (
              ...
              {isFeatureEnabled('sellerCatalog') && (
              ...
              {isFeatureEnabled('sellerAnalytics') && (
              ...
              {isFeatureEnabled('sellerReturns') && (
          ...
          <div className="pt-4 border-t border-[#E5E5E5] text-[11px] space-y-2">
            ...
            <div className="space-y-1">
              {isFeatureEnabled('accountProfile') && (
